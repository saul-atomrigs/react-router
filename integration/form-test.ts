    ...
    fixture = await createFixture({
      files: {
        ...
        "app/routes/blog.tsx": js`
                  import { Form, Outlet } from "@react-router/react";
                  export default function() {
                    return (
                      <>
                        <h1>Blog</h1>
        ...
        "app/routes/form-method.tsx": js`
                  import { Form, useActionData, useLoaderData, useSearchParams } from "@react-router/react";
                  import { json } from "@react-router/node";
        ...
        "app/routes/file-upload.tsx": js`
                  import { Form, useSearchParams } from "@react-router/react";
        ...
        "app/routes/outputFormData.tsx": js`
                  import { useActionData, useSearchParams } from "@react-router/react";
        ...
        "app/routes/pathless-layout-parent.tsx": js`
                  import { json } from '@react-router/server-runtime'
                  import { Form, Outlet, useActionData } from '@react-router/react'
